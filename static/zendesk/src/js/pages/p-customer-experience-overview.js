var CustExpMicrosite = {
  ...
  init: function() {
    ...
    webutils.trackIntent('CustExpOverview');
  ...
  // start animation when in viewort.
    ...
    //scroll animation for overview page
    $(window).scroll(webutils.debounce(function() {
      checkAnimation('.success-circle');
      checkAnimation('.network-stroke.stroke-1');
      checkAnimation('.network-stroke.stroke-2');
      checkAnimation('.network-stroke.stroke-3');
    }, 100));
